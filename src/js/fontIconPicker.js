...
(function ($) {
    ...
    var defaults = {
        ...
        allCategoryText: '所有类别', // The text for the select all category option
        unCategorizedText: '未分类'                 // The text for the select uncategorized option
    };
    ...
    function Plugin(element, options) {
        ...
        this.iconPicker = $('<div/>', {
            ...
            html: '<div class="selector">' +
                    ...
                    '<i class="fa fa-ban empty" title="无图标"></i>' +
                    '</span>' +
                    ...
                    '<div class="selector-popup" style="display: none;">' + ((this.settings.hasSearch) ?
                            ...
                            '<input type="text" name="" value="" placeholder="搜索图标" class="icons-search-input"/>' +
    ...
    Plugin.prototype = {
        ...
        init: function () {
            ...
            if (typeof (this.settings.source) === 'string') {
                $.get(this.settings.source, function (rs) {
                    that.settings.source = rs;
                    that.init();
                });
                return false;
            }
        ...
        loadIcons: function () {
            ...
            this.iconContainer.html('<i class="fa-spinner fa-spin loading"></i>');
        ...
        renderIconContainer: function () {
            ...
            if (this.settings.emptyIcon) {
                ...
                this.iconContainer.html('<span class="fip-box"><i class="fa fa-ban empty" data-fip-value="fa fa-ban empty" title="无图标"></i></span>');

                // If not show an error when no icons are found
            } else if (iconsPaged.length < 1) {
                this.iconContainer.html('<span class="icons-picker-error"><i class="fa fa-ban empty" data-fip-value="fa fa-ban empty" title="无图标"></i></span>');
                return;
        ...
        setSelectedIcon: function (theIcon) {
            ...
            if (this.settings.useAttribute) {
                if (theIcon) {
                    ...
                    this.iconPicker.find('.selected-icon').html('<i class="fa fa-ban empty" title="无图标"></i>');
                }
                // Use class
            } else {
                this.iconPicker.find('.selected-icon').html('<i class="' + (theIcon || 'fa fa-ban empty') + '" title="' + (theIcon || '无图标') + '"></i>');
            }
        ...
        toggleIconSelector: function () {
            ...
            this.iconPicker.find('.selector-button i').toggleClass('fa-caret-down');
            this.iconPicker.find('.selector-button i').toggleClass('fa-caret-up');
            if (this.open) {
